...
if not single_run:
    ...
    sim_runs = [3]   # Should only have one value, the value specifies the random seed
...
time_gen = TimeGeneration(multiply_local * 0.013015156, 0.0, 1e-10,
                          multiply_global * 0.131604348, 0.0, 1e-10)
